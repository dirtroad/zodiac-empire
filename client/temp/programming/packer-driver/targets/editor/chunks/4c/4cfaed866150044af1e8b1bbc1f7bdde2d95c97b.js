  ...
  return {
    ...
    execute: function () {
      ...
      _export("HomePage", HomePage = (_dec = ccclass('HomePage'), _dec2 = property({
        ...
        createUI() {
          const game = (_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
            error: Error()
          }), GameManager) : GameManager).instance;
          const user = game == null ? void 0 : game.userData;
          if (!user) return; // === 顶部区域 ===
        ...
        createEmotionCards() {
          ...
          const emotions = ((_instance2 = (_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
            error: Error()
          ...
          config.forEach((e, i) => {
            const x = -270 + i * 135;
            const data = emotions.find(d => d.emotionType === e.type);
            const amount = (data == null ? void 0 : data.amount) || 0; // 卡片
        ...
        addCollectButton(x, y, emotionType) {
          ...
          node.on(Node.EventType.TOUCH_END, async () => {
            ...
            try {
              ...
              await ((_instance3 = (_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
                error: Error()
