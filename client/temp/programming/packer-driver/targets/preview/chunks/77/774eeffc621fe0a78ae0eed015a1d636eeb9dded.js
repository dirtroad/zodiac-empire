    ...
    execute: function () {
      ...
      _export("UserInfo", UserInfo = (_dec = ccclass('UserInfo'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec(_class = (_class2 = class UserInfo extends Component {
        ...
        refresh() {
          ...
          return _asyncToGenerator(function* () {
            var user = (_crd && gameState === void 0 ? (_reportPossibleCrUseOfgameState({
              error: Error()
            }), gameState) : gameState).user || (yield (_crd && api === void 0 ? (_reportPossibleCrUseOfapi({
              error: Error()
            }), api) : api).getUserInfo());

            _this.updateDisplay(user);
          })();
        }
        ...
        static createUserInfoUI(parent, user) {
          var container = new Node('UserInfo');
          container.parent = parent;
          container.setPosition(200, 280, 0);
          container.layer = Layers.Enum.UI_2D;
          var uiTransform = container.addComponent(UITransform);
          ...
          var avatarLabel = avatarNode.addComponent(Label);
          avatarLabel.string = '👤';
          ...
          var nameTransform = nameNode.addComponent(UITransform);
          ...
          var levelNode = new Node('Level');
          levelNode.parent = container;
          levelNode.setPosition(30, -15, 0);
          levelNode.layer = Layers.Enum.UI_2D;
          var levelTransform = levelNode.addComponent(UITransform);
          levelTransform.setContentSize(150, 25);
          var levelLabel = levelNode.addComponent(Label);
